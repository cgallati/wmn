  ...
  return (
    <footer className="text-sm text-neutral-500">
      <div className="container">
        <div className="flex w-full flex-col gap-6 border-t border-neutral-200 py-12 text-sm md:flex-row md:gap-12">
          <div>
      ...
      <div className="border-t border-neutral-200 py-6 text-sm">
        <div className="container mx-auto flex w-full flex-col items-center gap-1 md:flex-row md:gap-0">
          ...
          <p className="md:ml-auto">
            <a className="text-black" href="https://payloadcms.com">
              Crafted by Payload
            </a>
          </p>
        </div>
